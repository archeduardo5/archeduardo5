...
import { Github, Linkedin, Twitter, Youtube, Mail, Award, Book, Code, Database } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 p-4">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold">Eduardo Ibarra</h1>
        <p className="text-xl text-gray-600">Architectural Engineer & Digital Innovator</p>
        <div className="flex justify-center space-x-4">
          <a href="https://github.com/archeduardo5" className="text-gray-600 hover:text-black">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-semibold">Architectural Design</h2>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600">
              Specializing in functional and aesthetically pleasing spaces that meet client needs and industry standards.
              Blending creativity with technical expertise for inspiring and practical designs.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-semibold">Digital Transformation</h2>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600">
              Leveraging BIM and cutting-edge digital tools to streamline workflows and enhance collaboration.
              Creating customized solutions for improved efficiency.
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-100 p-3 rounded-lg text-center">
              <p className="font-medium">BIM</p>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg text-center">
              <p className="font-medium">Construction Documentation</p>
            </div>
            <div className="bg-gray-100 p-3 rounded-lg text-center">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-xl font-semibold">Standards & Certifications</h2>
          </div>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="border p-4 rounded-lg">
              <h3 className="font-semibold">ISO 19650</h3>
              <p className="text-sm text-gray-600">Information Management</p>
            </div>
            <div className="border p-4 rounded-lg">
              <h3 className="font-semibold">AIA</h3>
              <p className="text-sm text-gray-600">BIM Integration</p>
            </div>
            <div className="border p-4 rounded-lg">
              <h3 className="font-semibold">RIBA</h3>
              <p className="text-sm text-gray-600">Work Planning</p>
            </div>
          </div>
        </CardContent>
      </Card>
...
![image](https://github.com/user-attachments/assets/410c6f33-9580-4a5b-bbce-1dec0b82dd8e)
